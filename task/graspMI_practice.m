...
[vp, starting_condition, ~, msf_colors, msf_text] = get_experimentInfo;
MonitorSelection = 3; % 6 in EEG, 3 in office, 4 in home office
MonitorSpecs = getMonitorSpecs(MonitorSelection); % subfunction, gets specification for monitor

%% PTB         
AssertOpenGL;
Screen('Preference', 'SkipSyncTests', 0); % may be set to 1 for testing
...
try
    ...
    RepsPerBlock              = 3; % number of repetitions per block (mouth, shoulder, forward)
